            ...
            <table class="table table-striped table-hover table-bordered">
                <thead class="table-light">
                    <tr>
                        <th>ID</th>
                        <th>
                            <a href="#" class="sort" data-sort="name" data-order="{{ request('order', 'asc') }}">Name</a>
                            <input type="text" id="nameSearch" class="form-control form-control-sm mt-2" placeholder="Search by name">
                        </th>
                        <th>
                            <a href="#" class="sort" data-sort="price" data-order="{{ request('order', 'asc') }}">Price</a>
                        </th>
                        <th>
                            <a href="#" class="sort" data-sort="quantity" data-order="{{ request('order', 'asc') }}">Quantity</a>
                        </th>
                        <th>Description</th>
                        <th>Actions</th>
                    </tr>
